...
bool my_func_compare(const struct list_elem* a,const struct list_elem* b)
{
...
thread_unblock (struct thread *t) 
{
  ...
  list_sort(&ready_list,my_func_compare,NULL);
...
thread_set_nice (int nice UNUSED) 
{
  /* Not yet implemented. */
	...
	list_sort(&ready_list,NULL,nice);
